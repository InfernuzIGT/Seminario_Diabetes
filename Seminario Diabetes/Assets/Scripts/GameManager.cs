...
public class GameManager : MonoBehaviour {
    ...
    [Range (0f, 10f)] public float transitionSpeed; //Velocidad de la transicion
    ...
    [Range (0f, 10f)] public float rotationSpeed; //Velocidad a la que rota el modelo para volver a su posicion inicial
    [Range (0f, 1f)] public float timeTurnOffRotation; //Tiempo que tarda en apagar la rotacion del modelo
    Quaternion modelRotY;
    bool isRotating;
